...
$Projectname это [b]свободное  и open source[/b] это набор веб приложений и сервисов, установленных на специальных вебсерверах под названием "хаб". Хабы соединены между собой в децентральной сети, называемой "гридом". Грид обеспечивает эффективный обмен информацией, управление учётными записями и управление доступом на различных домейнах и на независимых вебресурсах. Это обеспечивает любому пользователю публикацию или [b]ограничение доступа[/b] к информации на "каналах". Канал является основополагающей, зашифрованным учётной записью, позволяющей идентификацию независимо от хаба, на котором эта учётная запись зарегистрирована. Эта революционное отделение онлайне идентификации от определённых вебресурсов и домейнов называется "кочующий двойник" и реализовано на базе Zot-протокола и является инновационной платформой для децентрального прецизионного гибкого управления доступом к информации и к другим ресурсам. 
